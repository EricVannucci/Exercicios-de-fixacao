def menu():
    ...
    print('[1] À vista dinheiro/cheque (10% desconto)\n'
          '[2] À vista cartão de débito (8% desconto)\n'
          '[3] À vista cartão de crédito (5% desconto)\n'
          '[4] 2X no cartão de crédito (5% acréscimo)\n'
          '[5] 3X ou mais no cartão de crédito (20% acréscimo)\n'
          '[6] Sair\n')
    ...
    if opcao == 1:
        ...
        if vezes == 2:
            ...
            print(f'Comprando R$ {compras:.2f} em 1 vez no crédito suas compras saem '
                  f'com desconto de 5%.'
                  f'\nValor com desconto: R$ {compras - (compras * 5 / 100):.2f}!')
        else:
            print(f'Comprando R$ {compras:.2f} em {vezes}X, suas compras saem '
